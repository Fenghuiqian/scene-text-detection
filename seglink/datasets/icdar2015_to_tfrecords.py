    ...
    with tf.python_io.TFRecordWriter(output_path) as tfrecord_writer:
        for idx, image_name in enumerate(image_names):
            ...
            for line in lines:
                ...
                labels_text.append(b'textword'); 
                labels.append(1);
            example = convert_to_example(image_data, image_name.encode('utf-8'), labels, ignored, labels_text, bboxes, oriented_bboxes, shape)
            tfrecord_writer.write(example.SerializeToString())
        
if __name__ == "__main__":
    root_dir = util.io.get_absolute_path('C:\\Users\\fengqian\\Documents\\ICDAR2015\\')
    output_dir = util.io.get_absolute_path('C:\\Users\\fengqian\\Documents\\ICDAR2015\\tfrecords\\')
